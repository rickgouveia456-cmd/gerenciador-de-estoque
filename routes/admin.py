...
def reativar_todos_itens():
    if request.method == 'POST':
        ...
        return redirect(url_for('admin_bp.reativar_todos_itens'))
...
@admin_bp.route('/admin/seed-colaboradores-estrutura-2026', methods=['POST'])
@admin_required
def seed_colaboradores_estrutura_2026():
    """Rota TEMPORÁRIA — adiciona os colaboradores da estrutura 2026."""
    _lista = [
        ("ADRIANO SANTOS RIBEIRO DA SILVA", "MONTADOR DE FORMA"),
        ("AILTON DA SILVA", "ENCANADOR"),
        ("ALBERTINO FRANCA DAS NEVES JUNIOR", "ARMADOR"),
        ("ALEX JESUS DA SILVA", "ARMADOR"),
        ("ALEX VITORIO SILVA", "AJUDANTE COMUM FORMA"),
        ("AMOS CONCEICAO DOS SANTOS", "AJUDANTE COMUM FORMA"),
        ("ANDERSON CONCEICAO DE JESUS", "PEDREIRO"),
        ("ANDERSON RODRIGUES DOS SANTOS", "ELETRICISTA"),
        ("ANDERSON SOUZA DE FRIAS", "MONTADOR DE FORMA"),
        ("ANIBAL SANTOS DANTAS", "ARMADOR"),
        ("ANTONIO ELSON SANTANA SANTOS", "PEDREIRO"),
        ("ANTONIO MARCOS DA SILVA COSTA", "AJUDANTE PRATICO DE ELETRICISTA"),
        ("ARILSON DE JESUS SOUZA", "ARMADOR"),
        ("CACIANO EVANGELISTA DOS REIS", "MONTADOR DE FORMA"),
        ("CARLOS ALBERTO BISPO DOS SANTOS", "AJUDANTE COMUM"),
        ("CARLOS ALBERTO CONCEICAO DE JESUS", "AJUDANTE PRATICO"),
        ("CARLOS CONCEICAO DOS SANTOS", "MONTADOR DE FORMA"),
        ("CARLOS DANIEL DA SILVA MARQUES", "AJUDANTE COMUM FORMA"),
        ("DAVI SILVA DOS SANTOS", "AJUDANTE PRATICO"),
        ("DENAILTON LEITE DOS SANTOS", "AJUDANTE COMUM"),
        ("DIEGO LIMA SANTOS", "AJUDANTE COMUM"),
        ("DIVINO CARDOSO DOS SANTOS", "AJUDANTE COMUM"),
        ("DOMINGOS DA SILVA MIRANDA", "AJUDANTE PRATICO DE ELETRICISTA"),
        ("EDILSON GONCALVES DA SILVA", "MONTADOR DE FORMA"),
        ("EDNALDO DOS SANTOS", "ARMADOR"),
        ("EDNILSON ASSIS DOS SANTOS", "AJUDANTE COMUM"),
        ("EDUARDO SILVA PIMENTEL", "AJUDANTE COMUM"),
        ("EDVAN MACHADO SANTOS", "OPERADOR DE GRUA"),
        ("EDVANDRO ALEXANDRE BORGES DO NASCIMENTO", "PEDREIRO"),
        ("EIDSON SILVA ROCHA", "AJUDANTE PRATICO DE ELETRICISTA"),
        ("FABIO ALMEIDA LIMA", "PEDREIRO"),
        ("FELIPE MESSIAS DE JESUS", "AJUDANTE PRATICO FORMA"),
        ("FERNANDO SOUZA MIRANDA", "PEDREIRO"),
        ("FRANCISCO CARLOS DOS SANTOS FILHO", "MONTADOR DE FORMA"),
        ("GABRIEL RIBEIRO DE SANTANA", "AJUDANTE PRATICO FORMA"),
        ("GEAN LIMA DE OLIVEIRA", "MONTADOR DE FORMA"),
        ("GECIVALDO FRANCISCO DE LIMA", "PEDREIRO"),
        ("GUILHERME DOS SANTOS SAMPAIO", "AJUDANTE COMUM FORMA"),
        ("ISAIAS NASCIMENTO CONCEICAO", "AJUDANTE COMUM"),
        ("ISMAEL FERREIRA SANTOS", "MONTADOR DE FORMA"),
        ("ITALO OLIVEIRA ARAUJO LIMA", "AJUDANTE PRATICO FORMA"),
        ("JAILTON RIBEIRO TOSTA", "PEDREIRO"),
        ("JAILTON SILVA SACRAMENTO", "MONTADOR DE FORMA"),
        ("JEAN DE JESUS LIMA", "AJUDANTE COMUM"),
        ("JEFFERSON MASCARENHAS", "PEDREIRO"),
        ("JOANDERSON ALMEIDA BISPO", "PEDREIRO"),
        ("JOAO PEDRO SILVA DOS SANTOS", "MONTADOR DE FORMA"),
        ("JOEL BARBOSA DOS SANTOS", "AJUDANTE COMUM FORMA"),
        ("JOILSON DOS SANTOS", "ARMADOR"),
        ("JONAS DE SENA BARRETO", "AJUDANTE COMUM"),
        ("JONATAS ARAUJO SANTANA", "AJUDANTE COMUM FORMA"),
        ("JORGE DOS SANTOS", "MONTADOR DE FORMA"),
        ("JOSE CLEONILDO", "AJUDANTE COMUM"),
        ("JOSENILTON SOUZA SANTOS", "MONTADOR DE FORMA"),
        ("JUDICAEL LEITE DOS SANTOS", "ELETRICISTA"),
        ("KAUAN VICTOR DA SILVA ALMEIDA", "AJUDANTE COMUM FORMA"),
        ("LEANDRO DOS SANTOS CONCEICAO", "AJUDANTE COMUM FORMA"),
        ("LEANDRO SANTOS CONCEICAO", "MONTADOR DE FORMA"),
        ("LUIS ALBERTO MOREIRA DA SILVA", "AJUDANTE COMUM"),
        ("LUIS SILVAN LOPES DOS SANTOS", "ELETRICISTA"),
        ("MADSON REIS SANTOS", "ARMADOR"),
        ("MARCEL OLIVEIRA DA CONCEICAO", "ARMADOR"),
        ("MARCELO BARBOSA RODRIGUES", "MONTADOR DE FORMA"),
        ("MARCIO DE JESUS DOS SANTOS", "PEDREIRO"),
        ("MARCIO SILVA DE ALMEIDA", "AJUDANTE COMUM FORMA"),
        ("MARLEI ASSIS DE SOUZA", "ELETRICISTA"),
        ("MATEUS SANTOS DE JESUS", "PEDREIRO"),
        ("MATHEUS RENQUEL PIANCO BITENCOURT MENEZES LIMA", "AJUDANTE PRATICO DE ELETRICISTA"),
        ("NAILTON CONCEICAO DE SOUZA", "AJUDANTE COMUM"),
        ("NEILSON MIRANDA SANTOS", "PEDREIRO"),
        ("NEILTON DA CRUZ SANTOS", "MONTADOR DE FORMA"),
        ("NILSON MATIAS DOS SANTOS", "MONTADOR DE FORMA"),
        ("RAIMUNDO CONCEICAO DOS SANTOS JUNIOR", "AJUDANTE COMUM FORMA"),
        ("RENAN SILVA MENEZES DOS SANTOS", "AJUDANTE COMUM FORMA"),
        ("RICARDO VASQUES LEMOS LEONI", "ELETRICISTA"),
        ("RIVALDO ALVES DOS SANTOS", "PEDREIRO"),
        ("ROBERTO FELIX GONCALVES", "PEDREIRO"),
        ("ROBISON SANTOS DA CONCEICAO", "PEDREIRO"),
        ("ROBSON BISPO DOS SANTOS", "PEDREIRO"),
        ("RODRIGO ALVES DOS SANTOS", "MONTADOR DE FORMA"),
        ("RODRIGO DA PURIFICACAO MENDES", "AJUDANTE COMUM"),
        ("RODRIGO SANTOS SOUZA", "PEDREIRO"),
        ("RONALDO DA CUNHA SANTOS", "MONTADOR DE FORMA"),
        ("ROQUE DOS SANTOS", "MONTADOR DE FORMA"),
        ("RUAN UITALO OLIVEIRA DE SOUZA", "ARMADOR"),
        ("SAMUEL BISPO DOS SANTOS", "PEDREIRO"),
        ("SAMUEL DAMASCENA DOS SANTOS", "AJUDANTE PRATICO DE ENCANADOR"),
        ("SERGIO ALVES DOS SANTOS MAISK", "MONTADOR DE FORMA"),
        ("THIEGO DE OLIVEIRA REIS", "MONTADOR DE FORMA"),
        ("TIAGO PEREIRA DA SILVA", "MONTADOR DE FORMA"),
        ("UBIRATTAN SANTOS SOUZA", "AJUDANTE COMUM FORMA"),
        ("VALDINEI ARAUJO DOS SANTOS", "MONTADOR DE FORMA"),
        ("VALDINEI LOPES", "ARMADOR"),
        ("VALMIR GOMES DE JESUS", "MONTADOR DE FORMA"),
        ("VALMIR GONCALVES DE OLIVEIRA", "PEDREIRO"),
        ("VINICIO DO VALE OLIVEIRA", "MONTADOR DE FORMA"),
        ("VINICIUS CAUA DA CRUZ", "AJUDANTE COMUM"),
        ("VINICIUS DANTAS DA SILVA", "MONTADOR DE FORMA"),
        ("WALISSON SILVA COSTA", "AJUDANTE COMUM FORMA"),
        ("WEBER OLIVEIRA DA LUZ", "AJUDANTE COMUM FORMA"),
        ("WELISSON FERREIRA DE SOUZA", "MONTADOR DE FORMA"),
        ("ADSON MUNIZ DA SILVA", "AJUDANTE PRATICO DE FORMA"),
    ]
    inseridos = 0
    ignorados = 0
    for nome, funcao in _lista:
        if not Colaborador.query.filter(Colaborador.nome.ilike(nome)).first():
            db.session.add(Colaborador(
                nome=nome.strip(), funcao=funcao.strip(),
                escopo='estrutura', ativo=True
            ))
            inseridos += 1
        else:
            ignorados += 1
    db.session.commit()
    flash(f'✅ {inseridos} colaboradores adicionados! ({ignorados} já existiam)', 'success')
    return redirect(url_for('colaboradores_bp.colaboradores'))
...
def seed_ferramentas_estrutura():
    ...
    return redirect(url_for('ferramentas_bp.ferramentas', alm_id=alm.id))
...
def backup_manual():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return redirect(url_for('admin_bp.backup_manual'))
